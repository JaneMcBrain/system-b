...
export const teamArticles = [
  ...
  },
  {
    ...
    text: 'Eine Schicht bei Veranstaltungen ist oft in den Abendstunden und körperlich fordernd. Ihr müsst rechnen, immer aufmerksam und konzentriert sein und dabei mit vielen Menschen in Kontakt stehen. Kurz gesagt: Gastronomie und Veranstaltungsarbeit fordern Energie. Dafür muss es dann auch die richtige Entlohnung geben. Nicht jeder kann am Anfang gleich alles. Um also einen Anreiz zu schaffen, staffeln wir deine Vergütung nach Expertise. Und selbstverständlich steht dir auch immer dein Trinkgeld zu!',
    actionLink: emailLinkTeam,
    actionText: emailTextTeam
  },
]
...
export const teamServices: AccordionContent[] = [
  ...
  },
  {
    ...
    text: 'Arbeite hinter den Kulissen und gestalte mit deinem Team eine Location, die sich sehen lässt. Bühne montieren, Bars bauen, Chillecken einrichten, aus einem Raum oder einer leeren Halle eine glänzende Eventlocation entstehen lassen und am Ende mit einem Blick auf das Erschaffene sagen: “Geil geworden, jetzt kommt der Abriss!” Wenn dich das anspricht, bist du richtig im Auf- & Abbau Team.',
    image: tech
  },
  {
...
export const customerServices: AccordionContent[] = [
  ...
  },
  {
    ...
    text: 'Bei uns ist das Hab und Gut deiner Gäste in guten Händen! Unsere Garderobencrew kümmert sich als erste und letzte Ansprechpartnerin auf deinem Event um alles, was nicht mit auf die Tanzfläche muss – und das immer mit System und einem freundlichen Lächeln!',
    image: wardrobe
  },
  {
    headline: 'Veran&shy;staltungs&shy;leitung ADL´s',
  ...
  },
  {
    ...
    text: 'Natürlich wollen auch deine Artists mit allem versorgt sein. Mit unseren Cateringhilfen ist das kein Problem – sie sind Backstage für die Künstler*innen da, schnippeln, spülen, verräumen und sorgen für ein gutes Bauchgefühl!',
    image: pans
  },
  {
    headline: 'Stagehands',
...
export const datenschutz = [
  ...
  {
    headline: "Beschwerderecht bei der zuständigen Aufsichtsbehörde",
  ...
  {
    headline: "Recht auf Datenübertragbarkeit",
  ...
  {
    headline: "Auskunft, Berichtigung und Löschung",
