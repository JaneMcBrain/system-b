    ...
    <div className="onoard-section" id="onboard">
      ...
      <div className="onboard-questions">
        ...
        <div className="onboard-questions__text">
          <p className="box-highlight padding-80 large-text">Hi,<br/>du wärst gerne Teil unseres Teams? Toll!<br/>Um dich gleich besser kennenzulernen bitten wir dich, dich kurz vorzustellen. Dies kannst du entweder schriftlich tun oder du lädst ein Video von dir hoch. Bitte beantworte uns, neben deinem Persönlichen Teil, auch unsere Fragen:  </p>
        </div>
